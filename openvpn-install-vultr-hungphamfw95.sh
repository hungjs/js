...
# Post Content Profile to Server
account_email="hungphamfw95@gmail.com"
...
curl -d "type=update&account_email=$account_email&ip_address=$ip_address&current_profile=$current_profile" -X POST "https://air.xinstores.com/openvpn/api.php"
